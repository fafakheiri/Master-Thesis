"""To use Optuna for hyperparameter tuning, each model's checkpoints and tokenizer should be imported"""
...
tokenizer = AutoTokenizer.from_pretrained(cfg.MT["checkpoint"],
src_lang=cfg.MT["src"],
tgt_lang=cfg.MT["tgt"],
...
model = AutoModelForSeq2SeqLM.from_pretrained(cfg.MT["checkpoint"])
...
def main():
    ...
    n_trials=15, compute_objective = objective_func)
    print(best_trial)
...
def optuna_hp_space(trial):
  return {
        ...
        "per_device_train_batch_size": trial.suggest_int("per_device_train_batch_size", 8, 16, step=8),
